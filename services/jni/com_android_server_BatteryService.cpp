...
#ifdef HAS_DOCK_BATTERY
    setIntField(env, obj, gPaths.dockbatteryCapacityPath, gFieldIds.mDockBatteryLevel, 100);
#endif

    setIntField(env, obj, gPaths.batteryCapacityPath, gFieldIds.mBatteryLevel, 100);
